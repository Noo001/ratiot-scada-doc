...
**Закрыты (пришёл ответ АГ):** ASD-6503 (кейс 25, закрыт как дубликат ASD-6496), ASD-6504 (кейс 26, разрешён и закрыт).
**Кейсы без тикета:** 4 (Modbus CSV/XML), 12/14/15 (скрыты из отчёта).
