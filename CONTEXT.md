...
- **Дата обновления в футере:** главная страница (`index.html`) и база знаний (`scada/index.html`, `scada/ux.html`) содержат дату последнего обновления. При значимых изменениях менять на текущую дату вручную (сегодня — 19 августа 2026).
