#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Скриншот кейса 26: JS-ошибки getListenerCode при открытии раздела через поиск в дереве."""
...
with sync_playwright() as p:
    ...
    # пользовательский путь: поиск и открытие раздела
    ...
    page.screenshot(path=str(OUT_DIR / "case26_js_errors_console.png"))
    browser.close()
    print("Скриншот сохранён: case26_js_errors_console.png")
