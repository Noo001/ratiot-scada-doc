...
- [Кейс 1. Ошибки создания ресурсов при первом запуске сервера](#кейс-1-ошибки-создания-ресурсов-при-первом-запуске-сервера)
- [Кейс 2. Режимы лицензирования free / trial не описаны в документации](#кейс-2-режимы-лицензирования-free--trial-не-описаны-в-документации)
- [Кейс 3. Инсталлятор запрашивает перезапись собственных файлов](#кейс-3-инсталлятор-запрашивает-перезапись-собственных-файлов)
- [Кейс 4. Импорт Modbus-регистров из CSV/XML теряет имена, описания и адреса](#кейс-4-импорт-modbus-регистров-из-csvxml-теряет-имена-описания-и-адреса)
- [Кейс 5. eventLog сбрасывает настройки колонок при поступлении событий](#кейс-5-eventlog-сбрасывает-настройки-колонок-при-поступлении-событий)
- [Кейс 6. В дереве тегов невозможно выбрать абсолютную модель в качестве источника](#кейс-6-в-дереве-тегов-невозможно-выбрать-абсолютную-модель-в-качестве-источника)
- [Кейс 7. NoSQL-хранилище событий ломает сервер](#кейс-7-nosql-хранилище-событий-ломает-сервер)
- [Кейс 8. HTML-сниппет сдвигает layout дашборда](#кейс-8-html-сниппет-сдвигает-layout-дашборда)
- [Кейс 9. Установка в нестандартную папку + замена лицензии приводит к отказу лицензирования](#кейс-9-установка-в-нестандартную-папку--замена-лицензии-приводит-к-отказу-лицензирования)
- [Кейс 10. Локальный магазин приложений отсутствует в веб-клиенте](#кейс-10-локальный-магазин-приложений-отсутствует-в-веб-клиенте)
- [Кейс 11. Вёрстка страницы 404](#кейс-11-вёрстка-страницы-404)
- [Кейс 12. В дистрибутиве остался логотип и брендинг AggreGate](#кейс-12-в-дистрибутиве-остался-логотип-и-брендинг-aggreggate)
- [Итог](#итог)
