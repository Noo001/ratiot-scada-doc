...
| 6. Дерево тегов: нет абсолютной модели как источника | Medium | Закрыто / не баг (by design, подтверждено документацией 6.41.11) |
...
| 18. Ссылки в демо ведут на AggreGate | Medium | Исправлено в 6.41.11 (все «Онлайн»-ссылки ведут на одну страницу buff-lab.ru) |
| 19. Дашборд Тревог не открывается в WEB | High | Не исправлено в 6.41.11 (АГ проверили соседний alertsMonitoring) |
...
| 24. Активация метаданных устройства не работает | Medium | Исправлено в 6.41.11 / поведение подтверждено (ASD-6502) |
...
| 27. Прямые ссылки на настройки сервера и лицензии возвращают JSON 404 | Medium | Закрыто / by design (ASD-6505); непоследовательность JSON/HTML 404 — см. кейс 14 |
| 28. Не работает перенос контекстов посредством приложений | High | Исправлено в 6.41.11-2553 (по ответу АГ, ASD-6521) / самостоятельно не проверялось |
| 29. Не работают дополнительные свойства при относительных инструментальных панелях | Low | Исправлено в 6.41.11-2553 (по ответу АГ, ASD-6523, задача №20649) / самостоятельно не проверялось |
| 30. Не работает eventLog при относительных инструментальных панелях | Low | Ожидает ответа коллег (АГ запросили контексты и сценарий, ASD-6522) |
