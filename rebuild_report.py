...
statuses = {
    ...
    8: "Подтверждён коллегами / АГ не воспроизвели на 6.41.10-2512, запрошен .prs дашборда — запросить у авторов отчёта",
