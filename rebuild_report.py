...
statuses = {
    ...
    2: "Частично: документация исправлена и чистая установка в режиме 100 тэгов работает, но лицензия называется «Network Manager Free License» и лимит 100 тэгов в UI не отображается (<a href='https://tibbotech.atlassian.net/servicedesk/customer/portal/1/ASD-6482'>ASD-6482</a>)",
    3: "Исправлено в 6.41.12-2562, подтверждено чистой интерактивной установкой: диалогов перезаписи файлов нет (<a href='https://tibbotech.atlassian.net/servicedesk/customer/portal/1/ASD-6483'>ASD-6483</a>)",
    4: "Закрыто АГ, самостоятельная проверка на 6.41.12 невозможна: драйвер Modbus отсутствует в free-дистрибутиве, магазин модулей недоступен (Connection store error) (<a href='https://tibbotech.atlassian.net/servicedesk/customer/portal/1/ASD-6484'>ASD-6484</a>)",
    ...
    6: "Дефектом не считаем (соответствует документации, принят ответ АГ); контроль на 6.41.12: воспроизвести нельзя — «Дерево тегов» недоступно в free-контуре (<a href='https://tibbotech.atlassian.net/servicedesk/customer/portal/1/ASD-6485'>ASD-6485</a>)",
    ...
    8: "Исправлено (не воспроизводится) в 6.41.12-2562, проверено самостоятельно: сниппет со стилями не сдвигает layout (<a href='https://tibbotech.atlassian.net/servicedesk/customer/portal/1/ASD-6476'>ASD-6476</a>)",
    ...
    18: "Pending: остаточные замечания по ссылкам фиксируются в ASD-6496; проверка на 6.41.12 отложена — демо-приложение отсутствует в чистой установке (<a href='https://tibbotech.atlassian.net/servicedesk/customer/portal/1/ASD-6496'>ASD-6496</a>)",
